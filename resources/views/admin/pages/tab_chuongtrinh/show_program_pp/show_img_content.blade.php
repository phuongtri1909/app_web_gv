            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">{{ __('all_content_develop') }}</h5>
                        </div>
                        <a href="{{ route('tabs-programs.component1pp.create', $tab->id) }}"
                            ...
                            <tbody>
                                @foreach ($tab_image_content as $index => $tab)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('tabs-programs.component1pp.edit', $tab->id) }}"
                                                class="mx-3"" title="{{ __('edit') }}">
                                                <i class="fa-solid fa-pencil"></i>
                                            </a>
                                            @include('admin.pages.components.delete-form', [
                                                'id' => $tab->id,
                                                'route' => route('tabs-programs.component1pp.destroy', [$tab->tab_id,$tab->id]),
