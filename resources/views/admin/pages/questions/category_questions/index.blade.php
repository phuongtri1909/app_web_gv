            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ route('categories-questions.create') }}" class="btn bg-gradient-primary btn-sm mb-0 px-2"
                                ...
                                @foreach ($categories as $key => $post)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('categories-questions.edit', $post->id) }}" class="mx-3"
                                                title="{{ __('edit') }}">
                                                <i class="fa-solid fa-pencil"></i>
                                            </a>
                                            @include('admin.pages.components.delete-form', [
                                                'id' => $post->id,
                                                'route' => route('categories-questions.destroy', $post->id),
