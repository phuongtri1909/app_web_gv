        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                ...
                <div class="card-body pt-4 p-3">
                    ...
                    <form action="{{ route('parents-children.store', $tab->id) }}" method="POST"
                            ...
                            @foreach ($languages as $language)
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <textarea name="description_{{ $language->locale }}" id="description_{{ $language->locale }}"
                                        class="form-control @error('description_{{ $language->locale }}') is-invalid @enderror" rows="3" >{{ old('description_' . $language->locale)  }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="component_type" class="form-control" id="component_type"
                                value="{{ old('component_type') }}" required>
                        ...
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'duration_' . $language->locale }}"
                                    ...
                                    value="{{ old('duration_' . $language->locale) }}">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('parents-children.index', $tab->id) }}"
