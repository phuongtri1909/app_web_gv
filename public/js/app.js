...
document.querySelector("form").addEventListener("submit", function (e) {
    ...
    const errorMessages = {
        ...
        recruitmentInfo: 'Vui lòng nhập thông tin đăng ký tuyển dụng nhân sự.',
        ...
        productIimage: 'Vui lòng chọn 1 hay nhiều ảnh',
        productVideo: 'Vui lòng chọn 1 video',
    ...
    Object.entries(fileInputs).forEach(([id, message]) => {
        ...
        const errorDisplay = document.getElementById(`error-message${id === 'file-upload' ? '1' : ''}`);
    ...
    const requiredFields = [
        { id: "representative_name", message: errorMessages.representativeName },
        ...
        { id: "head_office_address", message: errorMessages.headOfficeAddress },
        ...
        { id: "residential_address", message: errorMessages.residentialAddress },
        ...
        { id: "product_image", message: errorMessages.productIimage },
        { id: "product_video", message: errorMessages.productVideo },
    ...
    const supportNeedInputs = document.querySelectorAll('input[name="support_need"]');
    const supportNeedSelected = [...supportNeedInputs].some(input => input.checked);
