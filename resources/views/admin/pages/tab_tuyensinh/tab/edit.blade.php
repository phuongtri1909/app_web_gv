    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">{{ __('edit_content_tab', ['tab'=> $tab->title]) }}</h5>
            </div>
            <div class="card-body pt-4 p-3">
                
                @include('admin.pages.notification.success-error')

                <form action="{{ route('content_tab.update',$tab_image_content->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <img id="image-preview" src="{{ asset($tab_image_content->image) }}" alt="Image Preview"
