    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">{{ __('add_personnel') }}</h5>
            </div>
            <div class="card-body pt-4 p-3">
                
                @include('admin.pages.notification.success-error')

                <form action="{{ route('staffs.store',$campus->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'position_'.$language->locale }}"
                                    ...
                                    value="{{ old('position_'.$language->locale)}}" required>
