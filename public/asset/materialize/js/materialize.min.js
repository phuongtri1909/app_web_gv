...
window.cash = (function () {
    ...
    function f (t) {
        if (!i) {
            var e = (i =
                o.implementation.createHTMLDocument(null)).createElement('base')
    ...
    (M.AutoInit = function (t) {
        var e = t || document.body,
            i = {
                ...
                CarouselCustom: e.querySelectorAll('.carousel-custom:not(.no-autoinit)'),
...
;(M.anime = (function () {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this.$tabLinks.each(function (t) {
                                        ...
                                        e.addClass('carousel-item-custom'),
                                            (n = n.add(e))
                                    })
                                    var t = a(
                                        '<div class="tabs-content carousel-custom carousel-slider"></div>'
                                    )
                                    n.first().before(t),
                                        t.append(n),
                                        (n[0].style.display = '')
                                    var e = this.$activeTabLink
                                        .closest('.tab')
                                        .index()
                                    ;(this._tabsCarousel = M.CarouselCustom.init(
                                        t[0],
                                        {
                                            fullWidth: !0,
                                            noWrap: !0,
    ...
    (function (b) {
            ...
            t = (function (t) {
                function i (t, e) {
                    ...
                    return (
                        ...
                        (n.hasMultipleSlides =
                            1 < n.$el.find('.carousel-item-custom').length),
                        (n.showIndicators =
                        ...
                        n.$el.find('.carousel-item-custom').each(function (t, e) {
                                    ...
                                    this.options.fullWidth
                                        ? ((this.itemWidth = this.$el
                                          ...
                                          (this.imageHeight = this.$el
                                              .find('.carousel-item-custom.active')
                                              .height()),
                                          (this.dim =
                                              2 * this.itemWidth +
        ...
        ;(M.CarouselCustom = t),
            M.jQueryLoaded &&
                M.initializeJqueryWrapper(t, 'CarouselCustom', 'M_Carousel')
    })(cash),
    (function (S) {
        'use strict'
