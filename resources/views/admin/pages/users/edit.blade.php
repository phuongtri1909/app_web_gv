    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">Chỉnh sửa tài khoản: {{ $user->full_name }}</h5>
            </div>
                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <img id="avatar-preview" src="{{ $user->avatar ? asset( $user->avatar) : '#' }}" alt="avatar Preview" style="display: {{ $user->avatar ? 'block' : 'none' }}; max-width: 200px; max-height: 200px; margin-top: 10px;">
                        </div>
