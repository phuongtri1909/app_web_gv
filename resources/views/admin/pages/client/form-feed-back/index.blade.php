                            ...
                            <tbody>
                                @foreach ($businessFeedbacks as $key => $feedback)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $feedback->businessMember->business_code ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $feedback->businessMember->business_name ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $feedback->businessMember->representative_full_name ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $feedback->businessMember->phone_zalo ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $feedback->businessMember->email ?? '-' }}</p>
                                        </td>
                                        <td>
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-group">
                                                <label class="text-uppercase text-xs font-weight-bolder opacity-7">
                                                    <i class="fas fa-building me-2"></i>{{ __('Địa chỉ') }}
                                                </label>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            ...
                                            <div class="modal fade" id="imagePreviewModal" tabindex="-1" aria-labelledby="imagePreviewModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <button type="button" class="btn-close btn-close-white d-flex align-items-center justify-content-between p-3 bg-dark" data-bs-dismiss="modal"></button>
                                                        <div class="modal-body">
                                                            <div class="position-relative">
                                                                <div class="text-center p-4" style="height: 500px;">
                                                                    <img id="previewImage" src="" class="img-fluid rounded h-100 w-100" style="object-fit: contain;" alt="Preview">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            $('.view-feedback').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#modal-owner-name').text(response.representative_full_name || '-');
                        $('#modal-phone').text(response.representative_phone || '-');
                        $('#modal-email').text(response.email || '-');
                        $('#modal-business-address').text(response.address || '-');
