    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ route('tabs-programs.component1.update', $tab_image_content->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('tabs-programs.component1', $tab_image_content->tab_id) }}" class="btn btn-secondary">{{ __('cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
