...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="d-flex m-0 justify-content-center text-wrap" href="{{ route('admin.dashboard') }}">
        <img class="" src="{{ asset('images/logo-hoi-doanh-nghiep.png') }}" alt="Flowbite Logo" style= "width: 80px; height: 80px;" />
    </a>
  </div>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="collapse mt-1" id="news" style="margin-left: 30px">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li>
                <a class="nav-link {{ Route::currentRouteNamed('tabs_posts.*') ? 'active' : '' }}" href="{{ route('tabs_posts.index') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-newspaper text-dark icon-sidebar"></i>
                  </div>
            ...
            <li>
                <a class="nav-link {{ Route::currentRouteNamed('news_contents.*') ? 'active' : '' }}" href="{{ route('news_contents.index') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-newspaper text-dark icon-sidebar"></i>
                  </div>
