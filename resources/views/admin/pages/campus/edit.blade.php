    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">{{ __('edit campus') }}</h5>
            </div>
            <div class="card-body pt-4 p-3">
                
                @include('admin.pages.notification.success-error')

                <form action="{{ route('campuses.update',$campus->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'title_'.$language->locale }}"
                                    ...
                                    value="{{ old('title_'.$language->locale,$campus->getTranslation('name',$language->locale))}}" required>
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <textarea name="description_{{ $language->locale }}" id="description_{{ $language->locale }}"
                                    ...
                                    required>{{ old('description_'.$language->locale,$campus->getTranslation('description',$language->locale)) }}</textarea>
                        ...
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'name_'.$language->locale }}"
                                    ...
                                    value="{{ old('name_'.$language->locale,$campus->getTranslation('name',$language->locale))}}" required>
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'address_'.$language->locale }}"
                                    ...
                                    value="{{ old('address_'.$language->locale,$campus->getTranslation('name',$language->locale))}}" required>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <img id="image-preview" src="{{ asset($campus->image) }}" alt="Image Preview"
