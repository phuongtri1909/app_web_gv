            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ route('ParentChildDetail.create.detail', $tab_projects->id) }}"
                        ...
                        @foreach ($mediaItems as $mediaItem)
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{ route('ParentChildDetail.edit.detail', [$tab_projects->id, $mediaItem->id]) }}"
                                        title="{{ __('edit') }}" class="mx-3"> <i class="fa-solid fa-pencil"></i>
                                    </a>
                                    @include('admin.pages.components.delete-form', [
                                        'id' => $mediaItem->id,
                                        'route' => route('ParentChildDetail.destroy.detail', [
                                            $tab_projects->id,
                                            $mediaItem->id,
                                        ]),
