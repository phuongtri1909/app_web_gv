    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">{{ __('edit_tab_menu') }}</h5>
            </div>
            <div class="card-body pt-4 p-3">
                
                @include('admin.pages.notification.success-error')

                <form action="{{ route('update.tab',$tab->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'title_'.$language->locale }}"
                                    ...
                                    value="{{ old('title_'.$language->locale, $tab->getTranslation('title',$language->locale)) }}" required>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <img id="image-preview" src="{{ asset($tab->banner) }}" alt="Image Preview"
                    ...
                    <div class="text-center">
                        ...
                        <a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-secondary">{{ __('cancel') }}</a>
                    </div>
                </form>
