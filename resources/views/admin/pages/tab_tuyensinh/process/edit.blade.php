    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ route('admission-process.update',$admissionProcess->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        @foreach ($languages as $language)
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" name="{{ 'title_'.$language->locale }}"
                                    ...
                                    value="{{ old('title_'.$language->locale,$admissionProcess->getTranslation('title', $language->locale))}}" required>
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <textarea name="content_{{ $language->locale }}" id="content_{{ $language->locale }}"
                                    ...
                                    required>{{ old('content_'.$language->locale,$admissionProcess->getTranslation('content', $language->locale)) }}</textarea>
